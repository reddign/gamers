...
<body>
    ...
    <h1>Etown Student Adventure</h1>
        <p>This is where ESA will go when complete.</p>
    
    <section id= "ESAPics">
        <img id="location_change" align="center" src="../../../web_src/games/ESA/images/foundersPLACEHOLDER.jpg" width=200 height=200>
    </section>
